...
module.exports = "<app-header-page></app-header-page> \n<!-- <app-login></app-login>\n<app-error-page></app-error-page>\n<app-signup></app-signup> \n  -->\n<router-outlet></router-outlet>"
...
/* harmony import */ var _header_page_header_page_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./header-page/header-page.component */ "./src/app/header-page/header-page.component.ts");
...
/* harmony import */ var _error_page_error_page_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./error-page/error-page.component */ "./src/app/error-page/error-page.component.ts");
...
/***/ "./src/app/dummy-page/dummy-page.component.css":
/*!*****************************************************!*\
  !*** ./src/app/dummy-page/dummy-page.component.css ***!
  \*****************************************************/
/*! no static exports found */
...
/***/ "./src/app/dummy-page/dummy-page.component.html":
/*!******************************************************!*\
  !*** ./src/app/dummy-page/dummy-page.component.html ***!
  \******************************************************/
/*! no static exports found */
...
module.exports = "\n<div>\n  <label>Event binding:</label>\n  <input type=\"text\" [value]=\"hi\">\n  <button (click)=\"f1()\" type=\"button\" >Click Me</button>\n</div>\n<br>\n<div>\n  <label>ngIf check:</label>\n  <div *ngIf=\"showMe\">\n    <p> ngIf is TRUE</p>\n  </div>\n</div>\n\n<br>\n<div>\n  <label>Attribute hidden:</label>\n  <div [hidden]=\"showMe\">\n    <p> Hidden is FALSE</p>\n  </div>\n</div>\n\n<br>\n<div>\n  <label>Attribute class:</label>\n  <div [ngClass]=\"{'error':showMe}\">\n    <p> Class attr is set</p>\n  </div>\n</div>\n\n<div>\n  <label>Attribute style:</label>\n  <div [ngStyle]=\"{'color':showMe ? 'green' : 'red' }\">\n    <p> Style  attr is set</p>\n  </div>\n</div>\n\n<div>\n  <label>ngFor:</label>\n  <div *ngFor=\"let data of b\">\n    <p> ngfor {{data}}</p>\n  </div>\n</div>"

/***/ }),

/***/ "./src/app/dummy-page/dummy-page.component.ts":
/*!****************************************************!*\
  !*** ./src/app/dummy-page/dummy-page.component.ts ***!
  \****************************************************/
...
var DummyPageComponent = /** @class */ (function () {
    ...
    DummyPageComponent.prototype.f1 = function () {
        // alert('Hi');
        this.hi = 'Value changed';
        this.showMe = !this.showMe;
    };
    DummyPageComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-dummy-page',
            template: __webpack_require__(/*! ./dummy-page.component.html */ "./src/app/dummy-page/dummy-page.component.html"),
            styles: [__webpack_require__(/*! ./dummy-page.component.css */ "./src/app/dummy-page/dummy-page.component.css")]
        }),
...
/***/ "./src/app/header-page/header-page.component.css":
/*!*******************************************************!*\
  !*** ./src/app/header-page/header-page.component.css ***!
  \*******************************************************/
/*! no static exports found */
...
var HeaderPageComponent = /** @class */ (function () {
    ...
    HeaderPageComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./header-page.component.html */ "./src/app/header-page/header-page.component.html"),
            styles: [__webpack_require__(/*! ./header-page.component.css */ "./src/app/header-page/header-page.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], HeaderPageComponent);
...
module.exports = "<form id=\"loginForm\" [formGroup]=\"loginForm\">\n  <div class=\"form-group\">\n    <label for=\"Username\">Username</label>\n    <input type=\"text\" formControlName=\"username\">\n    <small  class=\"error\"*ngIf=\"loginForm.controls.username.errors?.required\">\n        Username is required\n    </small>\n    <small class=\"error\" *ngIf=\"loginForm.controls.username.errors?.minlength\">\n        Username should have minimum {{loginForm.controls.username.errors?.minlength.requiredLength}} but got\n        {{loginForm.controls.username.errors?.minlength.actualLength}}.\n    </small>\n    <small class=\"error\" *ngIf=\"loginForm.controls.username.errors?.maxlength\">\n        Username should be maximum {{loginForm.controls.username.errors?.maxlength.requiredLength}} but got\n        {{loginForm.controls.username.errors?.maxlength.actualLength}}.\n    </small>\n</div>\n  <div class=\"form-group\">\n    <label for=\"password\">password</label>\n    <input type=\"password\" formControlName=\"password\">\n  </div>\n  \n  <small class=\"error\" *ngIf=\"loginForm.touched\">\n    User touched the form\n  </small>\n  <small class=\"error\" *ngIf=\"loginForm.untouched\">\n      User is not touched the form\n  </small>\n  <div class=\"link\">\n    <a href=\"#\">Forgot Password</a>\n  </div>\n  <div class=\"loginButton\">\n    <button (click)=\"login()\">Login</button>\n  </div>\n</form>"
...
module.exports = "<div class=\"container\">\n  <h2><i class=\"fas fa-angle-double-left\"></i> Pagination Example</h2>\n  <div class=\"pagination\">\n    <button class=\"fas fa-angle-double-left\" (click)=\"setPage(0)\"></button>\n    <button class=\"fas fa-angle-left\" (click)=\"setPage(page-1)\"></button>\n    <button *ngFor=\"let data of pageButton\" (click)=\"setPage(data-1)\">{{data}}</button>\n  <!--  \n    <button class=\"\" (click)=\"setPage(0)\">1</button>\n    <button class=\"\" (click)=\"setPage(1)\">2</button>\n    <button class=\"\" (click)=\"setPage(2)\">3</button>\n    <button class=\"\" (click)=\"setPage(3)\">4</button>\n  -->\n    <button class=\"fas fa-angle-right\" (click)=\"setPage(page+1)\"></button>\n    <button class=\"\tfas fa-angle-double-right\" (click)=\"setPage(lastPage)\"></button>\n    \n   \n\n    <label >Search</label><input type=\"text\"> \n    <label for=\"rows\">No of Rows</label>\n    <select id=\"rows\" (change)=\"noRow()\">\n      <option *ngFor=\"let row of noOfRecord\">{{row}}</option>\n      <!--<option [value]=\"tot\">10</option>\n      <option [value]=\"tot\">20</option>\n      <option [value]=\"tot\">30</option>\n      <option [value]=\"tot\">40</option>\n      -->\n    </select>\n  </div>\n\n  \n\n  \n  <table class=\"table table-bordered\">\n    <thead>\n      <tr>\n        <th>postId</th>\n        <th>Id</th>\n        <th>Name</th>\n        <th>Email</th>\n        <th>Body</th>\n      </tr>\n    </thead>\n    <tbody>\n      <tr *ngFor=\"let data of dataSample;index as i\">\n       <td *ngIf=\"i>=initial && i<end\">{{data.postId}}</td>\n        <td *ngIf=\"i>=initial && i<end\">{{data.id}}</td>\n        <td *ngIf=\"i>=initial && i<end\">{{data.name}}</td>\n        <td *ngIf=\"i>=initial && i<end\">{{data.email}}</td>\n        <td *ngIf=\"i>=initial && i<end\">{{data.body}}</td>\n   \n      </tr>\n    </tbody>\n  </table>\n</div>"
...
var PaginationComponent = /** @class */ (function () {
    function PaginationComponent() {
        ...
        this.lastPage = 0;
        this.pageButton = [1, 2, 3, 4, 5, 6];
        this.noOfRecord = [10, 20, 30, 40, 50];
        this.dataSample = [
            {
                "postId": 1,
                "id": 1,
    ...
    PaginationComponent.prototype.noRow = function () {
        alert('Hi');
        //this.hi = 'Value changed';
        //this.showMe=!this.showMe;
    };
    PaginationComponent.prototype.generatePageButton = function () {
        this.pageButton = [];
    ...
    PaginationComponent.prototype.findLastPage = function () {
        //alert('hi');
...
module.exports = "<!-- <form id=\"signupForm\"> -->\n<div id=\"signupForm\">\n  <div class=\"form-group\">\n    <label for=\"Username\">Username</label>\n    <input type=\"text\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"password\">password</label>\n    <input type=\"password\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"password\">Re-enter password</label>\n    <input type=\"password\">\n  </div>\n  <div class=\"submtButton\">\n    <button>Submit</button>\n  </div>\n</div>\n<!-- </form> -->"
